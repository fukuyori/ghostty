    ...
    return struct {
        ...
        pub fn init(alloc: Allocator, options: renderer.Options) !Self {
            ...
            const supports_custom_shaders = if (@hasDecl(GraphicsAPI, "supports_custom_shaders"))
                ...
                true;
            const has_custom_shaders = supports_custom_shaders and
        ...
        pub fn threadExit(self: *Self) void {
            {
                ...
                if (comptime builtin.os.tag == .windows) self.deinitShaders();
        ...
        fn drawFrameLocked(
            ...
            if (!needs_redraw) {
                if (comptime @hasDecl(GraphicsAPI, "presentLastTarget")) {
